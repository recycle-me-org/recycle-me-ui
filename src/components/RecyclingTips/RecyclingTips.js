...
const RecyclingTips = () => (
  <section className="recycling-tips-container">
    <div className="what-to-recycle-style">
      ...
      <p className="recycle-facts">
        ...
        no-no. Newspapers, mail and magazines, office paper, and notebook paper
        get the recycle bin green light.
      </p>
      <p className="recycle-item">Cardboard</p>
      <p className="recycle-facts">
        Clean moving, shipping and food boxes (cereal, crackers, cookies, etc.),
        as well as juice and milk containers, are recyclable as long as they’re
        rinsed out. The non-greasy side of a pizza box is okay too. Just tear
        off the dirty side, throw it away and put the clean side in the recycle
        bin.{' '}
      </p>
      ...
      <p className="recycle-facts">
        Never put broken glass in the recycling bin. Whether it’s broken window
        glass or a broken beer bottle, just don’t do it. It can clog machinery
        and be dangerous for workers handling the recyclables.
      </p>
      <p className="recycle-item">Metals</p>
      <p className="recycle-facts">
        Soda cans, as well as soup, tuna, and bean cans, are recyclable. Again-
        just make sure they’re empty, clean and dry! Give them a rinse and tip
        them over to drain before tossing in the recycle bin. Clean aluminum
        foil that isn’t contaminated with food is also acceptable. Never include
        aluminum foil with food stuck to it, bottle caps, or soda can tabs (on
        their own) or razor blades.
      </p>
      ...
      <p className="recycle-facts">
        E-waste includes consumer electronics including: laptops, mobile phones,
        and TVs. These products can contain toxic substances, so disposing of
        them properly is even more important for the planet. Use our map to find
        a recycling location near you.
      </p>
    </div>
    <div className="tips-for-recycling-style">
      <h1 className="tips-for-recycling">Tips For Recycling</h1>
      <ul type="circle">
        <li>
          Make sure it’s clean! One single dirty product can contaminate an
          entire bale. It can ultimately cause recyclable items to get
          redirected into a landfill.
        </li>
        <li>
          Flatten cardboard. This will save space in your bin and make room for
          more recycling.
        </li>
        <li>Look for products made out of recycled materials when you shop.</li>
        <li>
        ...
        <li>Keep Things Loose! Don’t Ever Bag Recyclables.</li>
        <li>No single-use utensils, paper plates, napkins, or paper towels.</li>
        <li>
