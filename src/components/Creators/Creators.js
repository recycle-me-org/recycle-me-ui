      ...
      <div className="frontend-and-backend-containers">
        <div className="frontend-container">
          ...
          <article className="member-container">
            ...
            <img className="profile-pic" src={ sarah } alt="Profile"/>
          ...
          <article className="member-container">
            ...
            <img className="profile-pic" src={ raquel } alt="Profile"></img>
          ...
          <article className="member-container">
            ...
            <img className="profile-pic" src={ anthony } alt="Profile"></img>
        ...
        <div className="backend-container">
          ...
          <article className="member-container">
            ...
            <img className="profile-pic" src={ michael } alt="Profile"/>
          ...
          <article className="member-container">
            ...
            <img className="profile-pic" src={ henry } alt="Profile"></img>
          ...
          <article className="member-container">
            ...
            <img className="profile-pic" src={ ezze } alt="Profile"></img>
